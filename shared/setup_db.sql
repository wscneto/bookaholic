...
('The Count of Monte Cristo', 'Alexandre Dumas', "Thrown in prison for a crime he has not committed, Edmond Dantes is confined to the grim fortress of if.", 62.29, 9, 'https://m.media-amazon.com/images/I/41EiXfNY6wL._SY445_SX342_.jpg'),
...
-- Adding an admin user to the 'users' table
INSERT INTO users (name, email, password_hash, is_admin) VALUES
('Admin', 'admin@bookaholic.com', '$2b$12$wQZSG0E8rc.t.1IVKul2G.TsliJZ2I/Yephg.qb96kjDQVZ61fuyW', TRUE);